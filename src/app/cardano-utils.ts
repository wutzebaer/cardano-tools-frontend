...
export class CardanoUtils {
    ...
    static getTimeLeftString(policy: PolicyPrivate): string {
        ...
        return `${countdown.daysToDday.toString().padStart(2, "0")}:${countdown.hoursToDday.toString().padStart(2, "0")}:${countdown.minutesToDday.toString().padStart(2, "0")}:${countdown.secondsToDday.toString().padStart(2, "0")}`;
    }
