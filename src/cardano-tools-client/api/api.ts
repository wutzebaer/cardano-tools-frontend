...
export const APIS = [AccountRestInterfaceService, DropRestInterfaceService, ExchangeRestInterfaceService, MintRestInterfaceService, QueryApiService, RegistrationRestInterfaceService, StakeRewardRestInterfaceService, TokenRestInterfaceService];
