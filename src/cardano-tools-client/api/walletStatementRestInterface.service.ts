...
export class WalletStatementRestInterfaceService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public prices(currency: string, observe?: 'body', reportProgress?: boolean): Observable<{ [key: string]: PriceDto; }>;
    public prices(currency: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<{ [key: string]: PriceDto; }>>;
    public prices(currency: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<{ [key: string]: PriceDto; }>>;
    public prices(currency: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<{ [key: string]: PriceDto; }>('get',`${this.basePath}/api/statement/prices`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
