...
export class WalletStatementRestInterfaceService {
  ...
  public accountStatement(
    ...
    if (stakeAddress === null || stakeAddress === undefined) {
      throw new Error(
        'Required parameter stakeAddress was null or undefined when calling accountStatement.',
      );
    }
    if (currency === null || currency === undefined) {
      throw new Error(
        'Required parameter currency was null or undefined when calling accountStatement.',
      );
    }
    ...
    let localVarPath = `/api/statement/${this.configuration.encodeParam({
      name: 'stakeAddress',
      value: stakeAddress,
      in: 'path',
      style: 'simple',
